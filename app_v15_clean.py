...
APP_VERSION = "v16 CLEAN - sidebar collapsed, no tip/banner"
...
st.markdown(
    ...
    <div class="hero">
        ...
        <div class="hero-subtitle">Review flock performance trends against standards and stitched rearing-to-layer history. v16 clean loaded.</div>
    </div>
    """,
    unsafe_allow_html=True,
)
